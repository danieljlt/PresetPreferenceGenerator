/*
  ==============================================================================
    ...
    Preset.h
    Created: 2 Feb 2025 10:54:07am
    Author:  Daniel Lister

    This file defines a simple struct for storing synthesizer presets.
    Each preset contains a name and a fixed-size array of 26 parameter values.
...
// Total number of parameters per preset
...
struct Preset {
    ...
    char name[40];              // Name of the preset (max 39 characters + null terminator)
    float param[NUM_PARAMS];    // Array of parameter values (raw, not normalized)
};
